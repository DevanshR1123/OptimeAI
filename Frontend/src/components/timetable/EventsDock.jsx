...
const EventsDock = () => {
    ...
    return (
        <>
            <div className="grid max-h-[calc(100vh_-_10rem)] grid-rows-sandwich gap-2 rounded-3xl bg-primary-700 p-4 font-bold">
                <button
                ...
                <div className="flex snap-y snap-mandatory scroll-p-2 flex-col gap-4 overflow-y-auto p-2">
                    {tiles.map((tile, index) => (
                        <div
                            ...
                            onClick={() =>
                                setSelectedTile(
                                    selectedTile?.id === tile.id ? null : tile,
                                )
                            }
...
const CreateDialog = ({
    ...
    return (
        <dialog
            ...
            className="grid grid-cols-2 grid-rows-sandwich gap-8 rounded-xl bg-primary-700 px-16 py-8 backdrop:bg-black/50 backdrop:backdrop-blur-sm"
        >
